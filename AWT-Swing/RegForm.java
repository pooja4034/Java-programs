...
public class RegForm extends Frame {
  ...
  RegForm() {
    ...
    add(txtname);
    txtname.setBounds(140, 40, 200, 30);
    ...
    add(txtmail);
    txtmail.setBounds(140, 80, 200, 30);
    ...
    add(txtclg);
    txtclg.setBounds(140, 120, 200, 30);
    ...
    add(txtphone);
    txtphone.setBounds(140, 160, 200, 30);
